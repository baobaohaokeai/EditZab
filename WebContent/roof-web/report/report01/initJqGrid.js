...
//	                '装机地址','停机竣工时间'
	...
	var colModel = [{name:'orderNo',index:'orderNo', width:100, align:"center",sortable:false
            ...
            },{name:'tel',index:'tel', width:100, align:"center",editable:true,sortable:false,summaryType:'sum',summaryTpl : '小计:{0}(元)'
...
//            rowNum : 10,
            ...
            colNames : colNames,
            colModel : colModel,
            footerrow : true,//底部列是否显示
            userDataOnFooter : true,//允许从userData中取值放到底部
            pager: "#con_grid_div_gridPager_1",
            
            grouping:true,
            groupingView : {
              groupField : ['businessType'],
              groupSummary : [true],//汇总
...
//		});
		...
		/* 加载固定数据 举例 */
		var data = [
		            {orderNo:'01',businessType:'业务类型01',tel:'139',internetId:001,consumerName:'张三'},
		            {orderNo:'02',businessType:'业务类型03',tel:'139',internetId:002,consumerName:'张4'},
		            {orderNo:'02',businessType:'业务类型01',tel:'139',internetId:002,consumerName:'张4'},
		            {orderNo:'02',businessType:'业务类型02',tel:'139',internetId:002,consumerName:'张4'},
		            {orderNo:'02',businessType:'业务类型01',tel:'139',internetId:002,consumerName:'张4'},
		            {orderNo:'02',businessType:'业务类型02',tel:'139',internetId:002,consumerName:'张4'},
		            {orderNo:'02',businessType:'业务类型01',tel:'139',internetId:002,consumerName:'张4'},
		            {orderNo:'02',businessType:'业务类型03',tel:'139',internetId:002,consumerName:'张4'},
...
//			userData:userData,
		...
		var total = $("#con_grid_div_grid_1").jqGrid('getCol','tel',false,'sum');
		var userData = {orderNo:'total',tel:'合计:'+total,internetId:20};
