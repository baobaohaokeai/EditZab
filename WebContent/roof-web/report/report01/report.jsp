...
<script src="${basePath}/roof-web/report/report01/report.js" type="text/javascript" language="javascript"/></script>
<script src="${basePath}/roof-web/report/report01/initJqGrid.js" type="text/javascript" language="javascript"/></script>
<script src="${basePath}/roof-web/report/common/toExport.js" type="text/javascript" language="javascript"/></script>
	
<title>停机订单竣工清单</title>
</head>
<body style="padding:5px;">
	<!-- header -->
	<div style="text-align: center;"><h2>停机订单竣工清单</h2></div>
		...
		<table border="0" cellpadding="0" cellspacing="1" class="ui-table" width="100%">
			<tbody>
				<tr>
					...
					<td width="15%"><input type="text" name="" style="width:80%;" value=""></td>
					<td class="ui-table-header2" style="text-align: center;" width="10%">结束时间</td>
					<td width="15%" colspan="3"><input type="text" name="" style="width:80%;" value=""></td>
				</tr>
