...
<script src="${basePath}/roof-web/report/report03/report.js" type="text/javascript" language="javascript"/></script>
<script src="${basePath}/roof-web/report/report03/initJqGrid.js" type="text/javascript" language="javascript"/></script>
