...
<script src="${basePath}/roof-web/report/report04/report.js" type="text/javascript" language="javascript"/></script>
<script src="${basePath}/roof-web/report/report04/initJqGrid.js" type="text/javascript" language="javascript"/></script>
