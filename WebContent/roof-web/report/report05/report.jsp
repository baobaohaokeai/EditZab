...
<script src="${basePath}/roof-web/report/report05/report.js" type="text/javascript" language="javascript"/></script>
<script src="${basePath}/roof-web/report/report05/initJqGrid.js" type="text/javascript" language="javascript"/></script>
