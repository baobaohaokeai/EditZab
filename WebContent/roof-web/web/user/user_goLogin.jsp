...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		jQuery('#login_btn').click(function() {
			...
			$.ajax({
				type : "POST",
				url : ROOF.Utils.projectName() + "/userAction/login.json",
				dataType : "json",
				data : {
					"username" : user_user_no,
					"password" : md5s
				},
				error : function(msg) {
					alert("Ajax调用失败");
				...
				success : function(result) {
					if ("success" == result.state) {
						// window.location.href = "userAction!goMain.action";
			...
			<div class="login">
				<ul class="content">
					<li>工&nbsp;&nbsp;&nbsp;号：&nbsp;<input name="j_username" type="text" id="j_username"
						style="width:150px; padding:3px 5px; border:#82BBD9 solid 1px;" value="" />
					</li>
